...
public:
	...
	/** getInputs Devuelve un puntero para el control de eventos en tiempo real
	 * @return Puntero con los eventos
	 */
	const sf::Input& getInputs() const;
...
private:
	...
	/**\brief Varibale settings
	 * Variable para almacenar propiedades de una ventana.
	 */
