...
public:
	...
	/**\brief Constructor desde grafo
	 * Hace la triangualarizacion a partir de un
	 * vector de nodos
	 * @param nodos vector de donde se cogeran los puntos
	 */
	Triangulation(std::vector<Node> nodos);
