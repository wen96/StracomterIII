...
Light::exportOpenGL() {
	...
	if(id >= 0)
	{
		...
		if(focus)
		{
			...
			dir[1] = 0;
			dir[2] = -1;
			glLightfv(GL_LIGHT0 + light, GL_SPOT_DIRECTION, dir);
			glLightf(GL_LIGHT0 + light, GL_SPOT_CUTOFF, 90);
			glLightf(GL_LIGHT0 + light, GL_SPOT_EXPONENT, 60);
			glLightf(GL_LIGHT0 + light, GL_LINEAR, 70);
		}
