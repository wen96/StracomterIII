...
public:
    ...
    /**\brief Elemina elemento (nodo) todo no esta hecha
     * \param elem - elemento a borrar*/
    ...
    GraphicNode* getNode(Graphics::DirectNodesEditor::Index);
    ...
    void makeEditorTree();
    void removeEditorTree();

    Graphics::Shader::Name getCurrentShader();
    void setCurrentShader(Graphics::Shader::Name);

    bool isShaderActive();
    void setShaderActive(bool shA);
...
private:
	...
	Graphics::Shader::Name currentShader;
	bool shadersActive;
};
