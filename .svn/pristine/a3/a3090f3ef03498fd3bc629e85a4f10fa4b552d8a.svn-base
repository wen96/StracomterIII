...
public:
	/**
	 * para singleton
	 * @return puntero con la clase
	 */
	static CharacterFeature* getInstance();

	/**
	 * Para singleton
	 * @param nomFich_ con el nombre del fichero de donde cargar las caracteristicas
	 * @return puntero a la clase instanciada
	 */
...
private:
    ...
    /**
     * Puntero para hacerla singleton
     */
