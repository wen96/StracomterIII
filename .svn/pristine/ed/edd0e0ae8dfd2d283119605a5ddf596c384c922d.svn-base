...
namespace Core {
	/**
	 * Variable para el radio por defecto de los jugadores
	 */
	const float Radius = 30;
	/**
	 * Radio por defecto para las explosiones
	 */
	const float explosionRadius = 150;
	namespace Element {
		enum Type {
				e_none = 0,
				e_camera = 1,
		...
		enum Type
			{
				...
				size = 18};       //!< size: Total de tipos, cambiar si aparecen mas
	...
	namespace Features{
		...
		namespace e_miniboss {
			namespace Color{
				const float red = 0.4;
				const float green = 0.4;
				const float blue = 0.4;
			};
			const float HP = 200;
			const float DPS = 1;
			...
			const unsigned int Moral = 0;
			const int expKill = 50;
		}
		namespace e_megaboss {
			namespace Color{
				const float red = 0.2;
	...
	/**
	 * Entero para asociar un nuermo con una senyal que signifique acabar el juego
	 */
