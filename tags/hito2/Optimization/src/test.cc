...
/*Funcion objetivo del Stracomter III: Mapa Ruben y dificultad 8 */
const string obj = "Max z x1 + x2 + x3";
const string r1 = "60x1 + 100x2 + 120x3 <= 5133.333";
const string r2 = "45x1 + 50x2+ 65x3 <= 2841.666";
const string r3 = "60x1 + 45x2 + 35x3 <= 2566.666";
